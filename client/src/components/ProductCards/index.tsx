    ...
    return (
        <Stack p={1} gap={1.5} width={'300px'} height={'300px'} sx={{ borderRadius: '15px', backgroundColor: 'white' }}>
            <Stack direction={'row'} justifyContent={'space-between'}>
                <Stack direction={'row'} gap={1}>
                    ...
                    <Stack gap={0.3} >
                        ...
                        <Box sx={{ fontSize: '14px', fontWeight: '600' }}>Rs 110</Box>
                    </Stack>
                </Stack>
            ...
            <Stack>
                ...
                <Box>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel, numquam libero corporis corrupti iusto alias voluptas aut, amet quas saepe magni incidunt possimus dignissimos, tempora velit mollitia ipsum quidem rem!</Box>
                <Box sx={{ fontSize: '14px', fontWeight: '600', paddingTop: '7px' }}> Stocks : 7</Box>
            </Stack>
        </Stack>
    )
}
